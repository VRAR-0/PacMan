 ...
 * Thu Mar 25 2021 16:39:29 GMT+0500 (Екатеринбург, стандартное время)
...
var move, CheckPointsPhones, CheckPointsCoins, CloneCoin;
...
CheckPointsCoins = ['CheckPoint1', 'CheckPoint2', 'CheckPoint3', 'CheckPoint4', 'CheckPoint5', 'CheckPoint6', 'CheckPoint7', 'CheckPoint8'];

operateAnimation('PLAY', '<none>', null, null, 'AUTO', 1,
        function() {}, undefined, false);

    for (var count = 0; count < 8; count++) {
  CloneCoin = cloneObject('coin');
  snapToObject(CloneCoin, CheckPointsCoins[mathRandomInt(0, 7)]);
}
