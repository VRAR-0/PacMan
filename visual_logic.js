 ...
 * Mon May 24 2021 16:36:36 GMT+0500 (Екатеринбург, стандартное время)
...
var health, CheckPointsPhones, isPlaying, move;
...
physicsBodyApplyParam('ANGULAR_FACTOR', 'PacMan', createVector(0, 0, 0));
onSimulationTick('BEFORE', function() {
  physicsBodyApplyParam('LINEAR_VELOCITY', 'PacMan', move);
  if (isPlaying) {
    if (getDistanceBetweenObjects('PacMan', 'Instance_ghost_ghost_physics') < 1.3) {
      snapBody('PacMan', 'CheckPoint13');
      snapToObject('ghost', 'CheckPoint14');
      health = health - 1;
      if (health < 3) {
        changeVis('Instance_Heart3_Heart_mesh', false);
      }
      if (health < 2) {
        changeVis('Instance_Heart1_Heart_mesh', false);
      }
      if (health < 1) {
        changeVis('Instance_Heart2_Heart_mesh', false);
        changeVis('GameOver', true);
        playSound(loadMedia_HTML5('./sounds/loose.mp3'), false);
        stopSound(loadMedia_HTML5('./sounds/music.mp3'));
        isPlaying = false;
      }
    }
  }
...
eventHTMLElem('keydown', ['DOCUMENT'], false, function(event) {
  ...
  if (getEventProperty('key', event) == 'ArrowDown') {
    ...
    setObjDirection('PacMan_body', 0, -90, 0, true, true);
  }
  ...
  if (getEventProperty('key', event) == 'ArrowLeft') {
    ...
    setObjDirection('PacMan_body', -90, 0, 0, true, true);
  }
...
registerEveryFrame(function() {
  setObjDirection('ghost', getObjTransform('PacMan', 'position', 'x'), getObjTransform('PacMan', 'position', 'y'), getObjTransform('PacMan', 'position', 'z'), true, false);
  applyObjLocalTransform('ghost', 'position', 2 * appInstance.elapsed * getObjDirection('PacMan', 'X'), 2 * appInstance.elapsed * getObjDirection('PacMan', 'Y'), '');
});
onSimulationTick('BEFORE', function() {
  physicsBodyApplyParam('LINEAR_VELOCITY', 'PacMan', move);
  if (getDistanceBetweenObjects('PacMan', 'Instance_ghost_ghost_physics') < 1) {
    snapBody('ghost', 'CheckPoint14');
  }
});

CheckPointsPhones = ['CheckPoint9', 'CheckPoint10', 'CheckPoint11', 'CheckPoint12'];
registerInterval(5, function() {
  snapToObject('Smart', CheckPointsPhones[mathRandomInt(0, 3)]);
});
createPhysicsBody('STATIC', 'coin1', 'BOX', 0);
createPhysicsBody('STATIC', 'coin2', 'BOX', 0);
createPhysicsBody('STATIC', 'coin3', 'BOX', 0);
createPhysicsBody('STATIC', 'coin.4', 'BOX', 0);
createPhysicsBody('STATIC', 'coin.5', 'BOX', 0);
createPhysicsBody('STATIC', 'coin6', 'BOX', 0);
playSound(loadMedia_HTML5('./sounds/music.mp3'), true);
volume(loadMedia_HTML5('./sounds/music.mp3'), 0.2);

detectCollision('PacMan', 'coin1', function() {
  changeVis('Instance_coin1_coin_mesh', false);
  setBodyState('DISABLE_SIMULATION', 'coin1');
  playSound(loadMedia_HTML5('./sounds/coins.mp3'), false);
  registerSetTimeout(10, function() {
    changeVis('Instance_coin1_coin_mesh', true);
    setBodyState('ENABLE_SIMULATION', 'coin1');
  });
}, function() {});

detectCollision('PacMan', 'coin2', function() {
  changeVis('Instance_coin2_coin_mesh', false);
  setBodyState('DISABLE_SIMULATION', 'coin2');
  playSound(loadMedia_HTML5('./sounds/coins.mp3'), false);
  registerSetTimeout(10, function() {
    changeVis('Instance_coin2_coin_mesh', true);
    setBodyState('ENABLE_SIMULATION', 'coin2');
  });
}, function() {});

detectCollision('PacMan', 'coin3', function() {
  changeVis('Instance_coin3_coin_mesh', false);
  setBodyState('DISABLE_SIMULATION', 'coin3');
  playSound(loadMedia_HTML5('./sounds/coins.mp3'), false);
  registerSetTimeout(10, function() {
    changeVis('Instance_coin3_coin_mesh', true);
    setBodyState('ENABLE_SIMULATION', 'coin3');
  });
}, function() {});

detectCollision('PacMan', 'coin.4', function() {
  changeVis('Instance_coin.4_coin_mesh', false);
  setBodyState('DISABLE_SIMULATION', 'coin.4');
  playSound(loadMedia_HTML5('./sounds/coins.mp3'), false);
  registerSetTimeout(10, function() {
    changeVis('Instance_coin.4_coin_mesh', true);
    setBodyState('ENABLE_SIMULATION', 'coin.4');
  });
}, function() {});

detectCollision('PacMan', 'coin.5', function() {
  changeVis('Instance_coin.5_coin_mesh', false);
  setBodyState('DISABLE_SIMULATION', 'coin.5');
  playSound(loadMedia_HTML5('./sounds/coins.mp3'), false);
  registerSetTimeout(10, function() {
    changeVis('Instance_coin.5_coin_mesh', true);
    setBodyState('ENABLE_SIMULATION', 'coin.5');
  });
}, function() {});

detectCollision('PacMan', 'coin6', function() {
  changeVis('Instance_coin6_coin_mesh', false);
  setBodyState('DISABLE_SIMULATION', 'coin6');
  playSound(loadMedia_HTML5('./sounds/coins.mp3'), false);
  registerSetTimeout(10, function() {
    changeVis('Instance_coin6_coin_mesh', true);
    setBodyState('ENABLE_SIMULATION', 'coin6');
  });
}, function() {});
